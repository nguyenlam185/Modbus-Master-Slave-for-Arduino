 ...
 * @ingroup setup
 */
void Modbus::begin(HardwareSerial *sPort, long u32speed)
{
...
uint8_t Modbus::validateRequest()
{
    ...
    uint16_t u16MsgCRC = ((au8Buffer[u8BufferSize - 2] << 8) | au8Buffer[u8BufferSize - 1]); // combine the crc Low & High bytes
...
int8_t Modbus::process_FC1(uint16_t *regs, uint8_t u8size)
{
    ...
    for (u16currentCoil = 0; u16currentCoil < u16Coilno; u16currentCoil++)
    {
        ...
        bitWrite(au8Buffer[u8BufferSize], u8bitsno,
